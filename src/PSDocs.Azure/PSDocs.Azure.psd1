...
GUID = '0bc9b4cf-d71d-4f77-8955-650c27e75d6a'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/Azure/PSDocs.Azure'

        # A URL to an icon representing this module.
        # IconUri = ''

        # ReleaseNotes of this module
        ReleaseNotes = 'https://github.com/Azure/PSDocs.Azure/blob/main/CHANGELOG.md'
