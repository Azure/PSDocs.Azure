...
PSDocs for Azure is licensed with an [:octicons-law-24: MIT License][1], which means it's free to use and modify.
...
- :octicons-git-pull-request-16: Contribute code.
  ...
  [1]: https://github.com/Azure/PSDocs.Azure/blob/main/LICENSE
